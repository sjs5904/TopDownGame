...
namespace MoreMountains.TopDownEngine
{
    ...
    public class WeaponAim : MonoBehaviour
    {
        ...
        [Header("CameraTarget")]
        /// whether the camera target should be moved towards the reticle to provide a better vision of the possible target
        [Tooltip("whether the camera target should be moved towards the reticle to provide a better vision of the possible target")]
